namespace Mariana.AVM2.Core {
    ...
    internal sealed class IndexProperty {
        ...
        public IndexProperty(
            Class indexType,
            Class? valueType,
            MethodTrait? getMethod,
            MethodTrait? setMethod,
            MethodTrait? hasMethod,
            MethodTrait? deleteMethod
        ) {
        ...
        /// <summary>
        /// Returns the <see cref="Class"/> representing the type of the numeric index.
        /// This must be one of int, uint or Number.
        /// </summary>
        public Class indexType => m_indexType;
